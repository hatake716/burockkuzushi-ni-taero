...
page=f'<!doctype html><html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>ブロック崩しに耐えろ！ 公開素材</title><style>{css}</style></head><body><main><div class="hero"><img class="icon" src="shared/icon-512.png" alt="ブロック再生のアイコン"><div><div class="tag">GOOGLE PLAY · MATERIALS 1.0.4</div><h1>ブロック崩しに耐えろ！</h1></div></div><p class="intro">hatake716 / acesmash@gmail.com<br>日本語・英語の実画面、動画、ストア文章の確認用ページです。プライバシーポリシーは<a href="https://hatake716.github.io/burockkuzushi-ni-taero/privacy/">公開済み</a>です。Google Play・YouTubeへの掲載は未実施です。</p><nav><a href="#ja-JP">日本語</a><a href="#en-US">English</a><a href="../PLAY_STORE.md">公開手順</a><a href="../privacy/index.html">Privacy</a><a href="../support/index.html">Support</a><a href="../PLAY_DECLARATIONS.md">申告資料</a></nav>'
for locale,label in [('ja-JP','日本語'),('en-US','English')]:
    ...
    page+='</div></section>'
page+='<footer>Android 1.0.4 · 40 blocks · 7-second CPU slot · Survival seconds²<br>実際のゲーム画面を使用。動画はオリジナル音源の編集ミックスです。<br><a href="CREDITS.md">素材・音源の記録</a> · <a href="asset-manifest.json">ファイルとSHA-256</a></footer></main></body></html>'
